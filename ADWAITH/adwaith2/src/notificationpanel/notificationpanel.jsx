                                ...
                                <li key={notif._id} className="notinotification-item">
                                    ...
                                    {notif.type === "hodstockforward" && (
                                        <div>
                                            ...
                                            <div className="notibtn-group">
                                                <button className="notiaccept-btn" onClick={() => handleHodStockAction(notif._id, "accept")}>✅ Accept</button>
                                                <button className="notidecline-btn" onClick={() => handleHodStockAction(notif._id, "reject")}>❌ Reject</button>
                                            </div>
                                        </div>
                                    )}
                                </li>
